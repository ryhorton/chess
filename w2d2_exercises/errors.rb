...
# I USED THE SOLUTION TO MASTERMIND TO IMPLEMENT ERROR HANDLING
...
class MinesweeperGame
  ...
  def initialize(size)
    if size >= 50
      raise "That's tough! I can't make that many bombs. Please reload."
    end
  ...
  def get_move
    ...
    puts "We just need action type, row and col inputs. Try again!"
    retry
  end
